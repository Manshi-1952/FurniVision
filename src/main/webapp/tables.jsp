...
<html>
<head>
  <title>Furniture Store - Tables</title>
  ...
  <section class="tables-section" >
    <div class="container">
      ...
      <div class="image-container">
        <img src="./Assets/dinn1.jpeg" alt="Dining Table">
      </div>

      <!-- Right: Text -->
      <div class="text-container">
        <h2>Elegant Dining Tables</h2>
        <p>Discover a range of beautifully crafted dining tables designed to enhance your dining experience. Whether for family gatherings or stylish dinner parties, our tables offer durability and elegance.</p>
      </div>
    </div>
  </section>
  ...
  <div class="product-container">
    <%
      try {
        ...
        preparedStatement.setString(1, "Tables");
